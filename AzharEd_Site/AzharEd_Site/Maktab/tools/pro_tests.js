...
// quiz: use a book guaranteed to have a question bank (hero book is random)
const qzCard = $$(".book-card").find(c => c.textContent.includes("Panda Counting Book") && c.textContent.includes("Nursery"));
clickEl(qzCard);
